        ...
        <main>
                ...
                <div class="full">
                    <div class="info_on_center">
                        <div class="bordered_text">
                            ...
                            <p>1.Бескомпромиссное качество - даже через 3 недели наш маникюр и педикюр выглядит так, как будто Вы сделали их вчера.</p>
                            <p>2.Безопасность кажлой процедуры -  мы используем методы стерилизации принятые в мед.учреждениях.</p>
                            <p>3.Индивидуальный подход и трепетное отношение к кажлому клиенту студии.</p>
                        </div>
                    </div>
            </div class="reviews">
            <center>
            ...
            <div class="prices">
                <div class="container">
                            ...
                            <div class="prices__inner">
                                ...
                                <div class="blur">
                                    <div class="prices__item bg2">
                                        <h3>Мастер Валерия</h3>
                                        <p>Стаж 3 года</p>
                                    </div>
                                </div>
                                <div class="blur">
                                    <div class="prices__item bg3">
                                        <h3>Мастер Екатерина</h3>
                                        <p>Стаж 2 года</p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div id="carousel">
                        <figure id="spinner">
                            <img src="./img/photo_1_2023-02-25_00-00-52.jpg" alt>
                            <img src="./img/photo_2_2023-02-25_00-00-52.jpg" alt>
                            <img src="./img/photo_3_2023-02-25_00-00-52.jpg" alt>
                            <img src="./img/photo_4_2023-02-25_00-00-52.jpg" alt>
                            <img src="./img/photo_5_2023-02-25_00-00-52.jpg" alt>
                            <img src="./img/photo_6_2023-02-25_00-00-52.jpg" alt>
                            <img src="./img/nogt1i.png" alt>
                            <img src="./img/nogt1i.png" alt>
                        </figure>
                    </div>
